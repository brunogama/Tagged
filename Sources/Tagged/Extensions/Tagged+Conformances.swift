...
where TagRawValue: CustomStringConvertible {
...
where TagRawValue: CustomDebugStringConvertible {
...
where TagRawValue: LosslessStringConvertible {
    ...
    public init?(_ description: String) {
        guard let value = TagRawValue(description) else { return nil }
        self.init(value)
    }
}
